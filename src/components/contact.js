...
import Instagram from "../../public/images/Vector (2).png";
    ...
    <div className="flex flex-col lg:flex-row lg:gap-10 justify-center p-14 gap-6 px-6 lg:px-0">
     <div className="flex flex-col justify-between">
       <div className="lg:w-[580px]">
        ...
        <p className="text-white text-sm lg:w-[280px]">Say hello at <a className="underline" href="mailto:alimatjamiu20@gmail.com">alimatjamiu20@gmail.com</a>. For more info, here’s my resume.</p>
        <div className="flex space-x-6">
          ...
          <a href="https://instagram.com/yourusername" target="_blank" rel="noopener noreferrer">
            <Image src={Instagram} alt="Instagram" width={30} height={32} />
          </a>
        </div>
      </div>
